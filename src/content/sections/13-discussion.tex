...
The audit procedure (Algorithm 1) is useful & Author synthesis & One reproducible small-scale execution (\cref{app:demo}); hardware-scale validation open (\cref{sec:audits}) \\

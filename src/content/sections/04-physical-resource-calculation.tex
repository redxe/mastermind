...
% TODO: run the worked circuit through an established resource estimator (e.g., Azure Quantum Resource Estimator) and replace the screening numbers with tool output plus a sensitivity table.

...
\paragraph{The gates are structured judgments.} Once evidence and thresholds are frozen, some verdicts reduce to quantitative comparisons. Judgment remains in formulating the problem contract, choosing baseline candidates and escalation evidence, deciding whether evidence satisfies a gate, and handling near-threshold cases. Every gate therefore records the evidence, assumptions, baseline, calculation, and rationale. The contract narrows discretion and leaves a record of it; it does not make judgment disappear. If qualified evaluators still disagree, the audit returns \textsc{insufficient-evidence}. Consistency across independent evaluators has not been measured, especially where competitive funding or commercial stakes may reward a favorable verdict.

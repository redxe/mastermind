...
The following questions can serve as a proposal template, design review, or research notebook. They are intentionally ordered. Skipping forward usually creates expensive rework. This section explains the order; \cref{app:worksheet} compresses the same discipline onto one page for repeated use.

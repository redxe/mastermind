...
\newcommand{\PaperTagline}{A problem-first framework from phase encodings to particle physics}
...
\newcommand{\PaperPdfKeywords}{quantum algorithms, resource estimation, hybrid computing, quantum error correction, particle physics}
\newcommand{\PaperKeywords}{quantum algorithms; resource estimation; hybrid quantum-classical computing; quantum error correction; quantum simulation; high-energy physics; scientific computing}

...
>
> **Still unproven:** physical-hardware execution (pipeline built, `--backend hardware` awaits IBM API key); framework value on genuinely uncertain instances; ORCID (title page TODO); field-by-field spot-check of canonical bib entries (SOURCE_VERIFICATION.md TODO); per-method quantum-bioinformatics literature comparison (§8, explicitly deferred).

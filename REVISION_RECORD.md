...
>
> **Still unproven:** framework value on genuinely uncertain instances; error-mitigated/corrected hardware performance; ORCID (title page TODO); field-by-field spot-check of canonical bib entries (SOURCE_VERIFICATION.md TODO); per-method quantum-bioinformatics literature comparison (§8, explicitly deferred). **Hardware run completed 2026-08-11:** IBM ibm_kingston (156-qubit Heron), Ê=-4.432±0.027 vs E_ref=-4.654 (+0.222 bias, 8.3σ), Gate-4 screen P0=0.971; artifacts/hardware/hardware_ibm_kingston/.
